      ...
      <div class="">
                    <div class="">
                        <div style="text-align: center" class="col-md-12">
                            <h2>Ingrese datos docentes y adminitrativos</h2><br>
                                <form action="insertar.php" method="POST">

                                    <input type="text" class="form-control mb-3" name="Estatus" placeholder="Estatus">
                                    <input type="text" class="form-control mb-3" name="Id" placeholder="Id">
                                    <input type="text" class="form-control mb-3" name="Numtrab" placeholder="Numero_trabajador">
                        ...
                        <div style="text-align: center" class="col-md-12">
                            <h2>Ingrese datos de Inicio de Sesion</h2><br>
                        ...
                        <div>
                            <table class="datatable" >
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th style="text-align: center"><?php  echo $row['Estatus']?></th>
                                                <th style="text-align: center"><?php  echo $row['Id']?></th>
                                                <th style="text-align: center"><?php  echo $row['Numtrab']?></th>
                                                <th style="text-align: center"><?php  echo $row['Nombre']?></th>    
                                                <th style="text-align: center"><?php  echo $row['Correo']?></th>
                                                <th style="text-align: center"><?php  echo $row['Contraseña']?></th>
                                                <th style="text-align: center"><?php  echo $row['Telefono']?></th>
                                                <th style="text-align: center"><?php  echo $row['Usuario']?></th>  
